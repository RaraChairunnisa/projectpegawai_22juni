...
import 'package:projectpegawai_22/screen_page/page_detail.dart';
import 'package:projectpegawai_22/screen_page/page_edit.dart';
import 'package:projectpegawai_22/screen_page/page_insert.dart';
...
class _PageUtamaState extends State<PageUtama> {
  ...
  Future<void> getEmployees() async {
    try {
      var response = await http.get(Uri.parse('http://192.168.1.7/pegawaiDB/getPegawai.php'));
  ...
  Future<void> deleteEmployee(String id) async {
    try {
      var response = await http.post(
        Uri.parse('http://192.168.1.7/pegawaiDB/deletePegawai.php'),
        body: {'id': id},
      );
      var jsonData = json.decode(response.body);
